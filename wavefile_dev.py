...
try:
    stereo_filename='.\garrotin_32bitfloat.wav'
    
    wf_stereo=wt.AudioFile()
    wf_stereo.read_wavefile(stereo_filename) 
    print('Num channels=',wf_stereo.m_numchannels)
    print('Sample rate (Hz)=',wf_stereo.m_samplerate_Hz)
    print('Num samples=',wf_stereo.m_numsamples)
    print('Duration (seconds)=',wf_stereo.m_duration_s)
    print('Type=',wf_stereo.m_data.dtype)
